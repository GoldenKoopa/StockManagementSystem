 ...
 * This record encapsulates the essential information of a user,
 * including their unique identifier, first name, last name, and username.
 */
public record UserDto(Long id, String firstName, String lastName,
   ...
   * @throws IllegalArgumentException if the user is null or if any required
   *     field
   *                                  is null or blank
   */
