package com.sms.stockmanagementsystem.project.controllers.v1;
...
public class GroupController {
  ...
  public String createGroup(@NotNull @RequestParam("name") String name,
  ...
  public String
  addToGroup(@NotNull @RequestParam("groupId") Integer groupId,
  ...
  getGroup(@NotNull @RequestParam("groupId") Integer groupId,
  ...
  @GetMapping("/groups")
  public List<Group>
  getAllGroups(@NotNull @RequestParam("secret") String secret) {
    return groupRepository.findAll();
  }

  @PostMapping("/renameGroup")
  public String
  renameGroup(@NotNull @RequestParam("groupId") Integer groupId,
  ...
  public String deleteFromGroup(@RequestParam("groupId") Integer groupId,
  ...
  @Autowired
  public GroupController(ContainerRepository containerRepository,
